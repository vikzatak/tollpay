...
/*namespace DPTPWebAPI.paymentGateway
{
    ...
    public class clspayUBiz
    {
        ...
        public string salt = "vAX4Blhu"; // string.Empty;
        public string Key = "BTheVC";  //string.Empty;
        public string env = "test";


        public clspayUBiz(string SALT, string KEY, string ENV)
        {
            salt = SALT;
            Key = KEY;
            env = ENV;
        ...
        //    var client = new RestClient(""https://secure.payu.in");
